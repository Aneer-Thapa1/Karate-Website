...
const Navbar = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center bg-transparent p-4 w-screen">
            <nav className="flex h-20 bg-white dark:bg-background-dark w-full rounded-2xl border border-gray-200 dark:border-gray-700
                    ...
                    {navItems.map((item) => (
                        <li
                            ...
                            className={`
                                ...
                                ${activeTab === item ? 'text-primary' : 'hover:text-primary'}
                            `}
            ...
            {menuVisiblity && (
                ...
                >
                    <div className="absolute right-0 top-0 h-screen w-72 bg-white dark:bg-background-dark
